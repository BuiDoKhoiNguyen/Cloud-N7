          ...
          <div className="p-5 flex flex-col gap-5">
            ...
            <div className="flex gap-5 relative items-center">
              {new Array(5).fill(0).map((e, i) => (
                <div className="h-8">
                  <img
                    className="w-8 h-8 absolute rounded-full border-2 border-surface object-cover"
              ...
              <div className="h-8">
                <div className="w-8 h-8 absolute rounded-full border-2 border-surface bg-primary text-onPrimary text-[10px] text-center content-center">
                  20+
                </div>
              </div>
